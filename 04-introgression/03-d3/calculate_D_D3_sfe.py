...
def D_D3_block_bootstrap(sp1_genome, sp2_genome, sp3_genome, sp4_genome, n_replicates):
	...
	return mean_D, mean_D3, D_stdev, D3_stdev

# Function to check proportions of positive and negative D3 windows.
...
df_trios = pd.read_csv("trios_sfe.csv", sep = '\t')
...
for idx in df_trios.index:
	...
	proportion = prop_D3_windows(sp2_genome, sp3_genome, sp4_genome)
	...
	# Print output.
	print(elements[1], elements[2], elements[3], D_stat, D3_stat, bootstraps[0], bootstraps[1], bootstraps[2], bootstraps[3], Zscore_D, Zscore_D3, pvalue_D_1tail, pvalue_D_2tail, pvalue_D3_1tail, pvalue_D3_2tail, proportion)